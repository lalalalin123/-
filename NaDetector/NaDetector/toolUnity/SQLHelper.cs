...
namespace PetDetector
{
    ...
    public abstract class SQLHelper
    {
        ...
        public static readonly string connectionString = System.Configuration.ConfigurationManager.ConnectionStrings["mysql"].ToString();
       // public static  string connectionString = "Database='petdetector';Data Source='localhost';User Id='root';Password='1234';charset='utf8';pooling=true";
        ...
        public static int ExecuteNonQuery(string cmdText, CommandType cmdType = CommandType.Text, params MySqlParameter[] commandParameters)
        {
            ...
            {
                PrepareCommand(cmd, conn, null, cmdType, cmdText, commandParameters);//指令装配
        ...
        public static void ExecuteTransaction(List<string> cmdText, CommandType cmdType = CommandType.Text, params MySqlParameter[] commandParameters)
        {
            try
            {
                MySqlCommand cmd = new MySqlCommand();
                using (MySqlConnection conn = new MySqlConnection(connectionString))
                {
                    ...
                    PrepareCommand(cmd, conn, transaction, cmdType, "", commandParameters);
                    try
                    {
