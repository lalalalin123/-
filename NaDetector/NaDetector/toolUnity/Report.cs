...
namespace PetDetector
{
    class Report
    {
        ...
        public void CreateNewDocument(string filePath)
        {
            ...
            wordApp.DisplayAlerts = WdAlertLevel.wdAlertsNone;//屏蔽警告框
        ...
        public void SaveDocument(string filePath)
        {
            ...
            object format = WdSaveFormat.wdFormatDocument;//保存格式word
            ...
            wordDoc.SaveAs(ref fileName, ref format, ref miss,
                ...
                ref miss, ref miss, ref miss, ref miss,
                ref miss);         
            object SaveChanges = WdSaveOptions.wdSaveChanges;//保存模板的修改
        ...
        {
            object fileName = filePath;
            object format = WdSaveFormat.wdFormatPDF;//保存格式pdf
            object miss = System.Reflection.Missing.Value;
            wordDoc.SaveAs(ref fileName, ref format, ref miss,
                ref miss, ref miss, ref miss, ref miss,
                ref miss, ref miss, ref miss, ref miss,
